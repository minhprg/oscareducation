...
from algebra import Equation, Inequation, EquationSystem 
...
# ===================================================================== GENERAL EXPRESSIONS CHECKS
    ...
    def test_expression_components(self):
        ...
        for expression_def in self.pool:
            ...
            self.assertEqual(expression.leftOperand, expression_def["left_operand"])
            self.assertEqual(expression.rightOperand, expression_def["right_operand"])
            self.assertEqual(expression.operator, expression_def["operator"])
